...
from syntax_checker import JsonSyntaxChecker
from validator import Validator
from interaction_model_generator import AlexaInteractionModelGenerator
from back_end_generator import AlexaBackEndGenerator
...
class AlexaSkillGenerator(PersonalAssistantGenerator):
	...
	def generate_personal_assistant(self, conf_file, conf_file_format="json"):
		...
		dest_path = os.getcwd() +"/"+skill_name
		try:
			os.mkdir(dest_path)
		except OSError:
