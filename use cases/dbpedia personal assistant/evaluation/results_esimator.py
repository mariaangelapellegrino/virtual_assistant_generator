...
def dbpedia_comparison():
	...
	print("DBPEDIA test on QALD-9 testing set")
...
def compare_results(gold_standard, system_replies):
	...
	for question in questions:
		...
		if "results" in correct_answers and "bindings" in correct_answers["results"]:
	...
	for question in questions:
		...
		if "results" in question["answers"][0] and "bindings" in question["answers"][0]["results"]:
